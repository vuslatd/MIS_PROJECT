...
while True:
    ...
    if calculation == '13':
        ...
        ineffective_element = 0
        while True:
            divide = float(input('BÖLMEK İSTEDİĞİNİZ SAYILARI SIRAYLA GİRİNİZ  (Çıkmak için 0 a basınız):'))
            if divide == 0:
                break
            elif boolean == True:
        ...
        if c < 0:
            absolute_value = c * -1
            print('MUTLAK DEĞERİN SONUCU : ', absolute_value)
        else:
            print('MUTLAK DEĞERİN SONUCU : ', c)
        ...
        if a < 0:
            ...
            for i in range(1, a + 1):
                factorial *= i
            print('SAYININ FAKTÖRİYELİ : ', factorial)
        ...
        while (True):
            if a <= 0:
                ...
                print("""TRİGONOMETRİK FONKSİYONLAR 
                    1 = Sin
                    2 = Cos
                    3 = Tan
                    4 = Cot
                ...
                calculation2 = input('YAPMAK İSTEDİĞİNİZ TRİGONOMETRİK İŞLEMİN NUMARASINI GİRİNİZ : ')

                if calculation2 == '1':
                    angle = float(input('AÇI GİRİNİZ : '))
                    sin = math.sin(math.radians(angle))
                    print('SİN DEĞERİ: {} '.format(sin))

                elif calculation2 == '2':
                    angle = float(input('Açıyı giriniz: '))
                    cos = math.cos(math.radians(angle))
                    print('COS DEĞERİ : {}'.format(cos))

                elif calculation2 == '3':
                    angle = float(input('AÇI GİRİNİZ : '))
                    tan = math.tan(math.radians(angle))
                    print('TAN DEĞERİ : {}'.format(tan))

                elif calculation2 == '4':
                    angle = float(input('AÇI GİRİNİZ : '))
                    cot = math.tan(math.radians(angle))
                    print('COT DEĞERİ : {}'.format(1 / cot))

                elif calculation2 == '5':
                    angle = float(input('AÇI GİRİNİZ : '))
                    radians = math.radians(angle)
                    print('SONUÇ : {}'.format(radians))
                else:
                    print('YUKARIDAKİ NUMARALARDAN BİRİNİ GİRİNİZ .')

    elif calculation == '12':
            a = float(input('MODUNU ALMAK İSTEDİĞİNİZ SAYIYI GİRİNİZ : '))
            b = float(input('MODUNU YAZINIZ : '))
            c = a % b
            print(f'{a} % {b} İŞLEMİNİN SONUCU : {c}')

    else:
        print('LÜTFEN YUKARIDAKİ NUMARALARIN BİRİNİ SEÇTİĞİNİZDEN EMİN OLUN.')
